...
Download PupilEXT Version 0.1.1 Beta (MAC): [(PupilEXT-macOS-0.1.1-Beta-Release.dmg, 95.2 MB)](https://bit.ly/3ArbB1l)
...
Download PupilEXT Version 0.1.1 Beta (Windows): [(PupilEXT-WIN-0.1.1-Beta-Release.zip, 41.6 MB)](https://bit.ly/2UnWqFW)
