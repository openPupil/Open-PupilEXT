...
Download PupilEXT Version 0.1.1 Beta (MAC): [(PupilEXT-macOS-0.1.1-Beta-Release.dmg, 95.2 MB)](https://storage.googleapis.com/pupilext-data-repository/PupilEXT-Releases/PupilEXT-macOS-Release-0.1.1-Beta.dmg)
...
Download PupilEXT Version 0.1.1 Beta (Windows): [(PupilEXT-WIN-0.1.1-Beta-Release.zip, 41.6 MB)](https://storage.googleapis.com/pupilext-data-repository/PupilEXT-Releases/PupilEXT-Windows-Release-0.1.1-Beta.zip)
